    ...
    init {
        context.theme.obtainStyledAttributes(
            ...
            try {
                ...
                STROKE_WIDTH = getFloat(R.styleable.Canvas_strokeWidth1,5f)
                paintColor = getColor(R.styleable.Canvas_paintColor1,Color.BLUE)
                paintBackgroundColor = getColor(R.styleable.Canvas_backgroundColor1,Color.WHITE)
